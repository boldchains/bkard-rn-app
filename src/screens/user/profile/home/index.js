          ...
          <ScrollView>
              ...
              <View>
                <View style={styles.businessContainer}>
                  ...
                  <View style={styles.businessInformationContainer}>
                    <Text style={[styles.userFullName, {marginTop: 0}]}>
                      Name of Business
                    </Text>
                    <Text style={styles.userCity}>{userDetails.address}</Text>
                    <Text style={styles.businessWebAddress}>
                      www.blablabla.com
                    </Text>
                  </View>
                </View>
            ...
            <View style={styles.buttonsContainer}>
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.button,
                  this.props.auth.role === 'business' ? {marginRight: 0} : null,
                ]}>
                <Text style={styles.buttonText}>
                  {this.props.auth.role === 'business' ? 'Invest' : 'Portfolio'}
                </Text>
              </TouchableOpacity>
            ...
            {this.props.auth.role === 'business' ? (
              <View>
                ...
                <View style={styles.productsServicesContainer}>
                  <Text
                    style={[
                      styles.recentPurchasesText,
                      {marginLeft: 10, marginBottom: 20},
                    ]}>
                    Business Details / Photos
                  </Text>
                  <ScrollView
                    showsHorizontalScrollIndicator={false}
                    horizontal
...
export default connect(mapStateToProps, {userRole, userDetails})(PrivateHome);
