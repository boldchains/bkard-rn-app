                        ...
                        <MenuItem icon={<SimpleLineIcons name="settings" size={25} color="white" />} expand={true} title="Account Settings" >
                            <View style={styles.collapseMenuContainer}>
                                ...
                                <TouchableOpacity onPress={() => this.props.navigation.navigate("ChangePassword")}>
                                    <Text style={[styles.optionsItemButtonText, { marginTop: 15 }]}>Change Password</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => this.props.navigation.navigate("Payments")}>
                                    <Text style={[styles.optionsItemButtonText, { marginTop: 15 }]}>Add/Edit Payments</Text>
                                </TouchableOpacity>
                            </View>
                        </MenuItem>
                        <MenuItem icon={<Image style={{ width: 26, height: 26 }} source={require("../../../assets/icons/privacyIcon.png")} />} expand={true} title="Privacy" >
                            <View style={styles.collapseMenuContainer}>
                                <TouchableOpacity onPress={() => this.props.navigation.navigate("LocationActiveStatus")}>
